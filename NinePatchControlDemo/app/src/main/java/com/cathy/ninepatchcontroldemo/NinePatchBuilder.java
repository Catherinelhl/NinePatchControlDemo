...
public class NinePatchBuilder {
    ...
    public NinePatchBuilder(Resources resources,Bitmap bitmap){
        ...
        xRegions.add(width/2);
        xRegions.add(width/2+1);

        yRegions.add(height/2);
        yRegions.add(height/2+1);
    }
    ...
    public NinePatchBuilder addYCenteredRegion(int height){
        int y=(int)((this.height-height)/2+6);
        yRegions.add(y);
        yRegions.add(y+height);
        return this;
    }
    public NinePatchBuilder addYCenteredRegion(int height,int Y){
        int y=(int)((this.height-height)/2+Y);
        yRegions.add(y);
        yRegions.add(y+height);
        return this;
    }
